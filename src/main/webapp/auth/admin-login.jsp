...
<head>
    ...
    <title>Admin Login - NIBM EVEX</title>
...
<body class="relative bg-cover bg-center sm:bg-auto lg:bg-cover" style="background-image: url('images/Galle_1.jpg');">
...
<script>
    document.getElementById("adminLoginForm").addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://virtserver.swaggerhub.com/ChanukaDilshan-8ba/event-management_system_api/1.0.0/admin/login", {
                method: "POST",
