...
<head>
    ...
    <title>Student Registration - NIBM EVEX</title>
...
<body class="relative bg-cover bg-center sm:bg-auto lg:bg-cover" style="background-image: url('images/student1.jpg');">
...
<section class="relative h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md relative z-10">
        ...
        <!-- Registration Form -->
        <form id="studentRegisterForm" class="space-y-6">
            <!-- Name Field -->
            <div>
...
<script>
    document.getElementById("studentRegisterForm").addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://virtserver.swaggerhub.com/ChanukaDilshan-8ba/event-management_system_api/1.0.0/admin/student/register", {
                method: "POST",
