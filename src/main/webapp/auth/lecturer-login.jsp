...
<head>
    ...
    <title>Lecturer Login - NIBM EVEX</title>
...
<body class="relative bg-cover bg-center sm:bg-auto lg:bg-cover" style="background-image: url('images/lecturer.jpg');">
...
<section class="relative h-screen flex items-center justify-center">
    ...
    <div class="bg-white shadow-lg rounded-lg p-8 w-full max-w-md relative z-10">
        <!-- Heading -->
        <h1 class="text-3xl font-bold text-center text-gray-800 mb-6">Lecturer Login</h1>
...
<script>
    document.getElementById("lecturerLoginForm").addEventListener("submit", async (e) => {
        ...
        try {
            ...
            const response = await fetch("https://virtserver.swaggerhub.com/ChanukaDilshan-8ba/event-management_system_api/1.0.0/lecturer/login", {
                method: "POST",
