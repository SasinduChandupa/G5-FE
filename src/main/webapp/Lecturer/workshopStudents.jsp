...
<head>
    ...
    <title>Workshop Students and Feedback</title>
...
<main class="flex-grow container mx-auto py-8 px-6">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">Workshop Students and Feedback</h2>
    <div class="bg-white shadow rounded-lg p-6">
        <%
            String workshopId = request.getParameter("workshopId");
            String studentsApiUrl = "http://localhost:8080/api/v1/workshop/" + workshopId + "/students";
            String feedbackApiUrl = "http://localhost:8080/api/v1/lecturer/received";
