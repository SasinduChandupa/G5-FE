...
<main class="flex-grow">
    <div class="max-w-6xl mx-auto py-10 px-4">
        ...
        <%
            String apiUrl = "http://localhost:8080/api/v1/event/all";
            ...
            if ("POST".equalsIgnoreCase(request.getMethod()) && request.getParameter("status") != null) {
                ...
                try {
                    String updateUrl = "http://localhost:8080/api/v1/lecturer/events/" + eid + "/status?status=" + newStatus;
            ...
            if ("POST".equalsIgnoreCase(request.getMethod()) && request.getParameter("delete") != null) {
                ...
                try {
                    String deleteUrl = "http://localhost:8080/api/v1/event/delete/" + eid;
