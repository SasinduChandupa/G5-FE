    ...
    <%
      if (request.getMethod().equalsIgnoreCase("POST")) {
        ...
        try {
          ...
          URL url = new URL("http://ec2-51-20-114-214.eu-north-1.compute.amazonaws.com:8081/api/v1/student/login");
          ...
          if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            response.sendRedirect("studentpanel/sessionhandler.jsp");
          } else {
