...
<body class="relative" style="background-image: url('auth/images/student.jpg'); background-size: cover; background-position: center; height: 100vh; margin: 0; background-attachment: fixed;">
...
<script>
  const studentLoginEndpoint = "http://ec2-51-20-114-214.eu-north-1.compute.amazonaws.com:8081/api/v1/student/login";
  ...
  async function studentLogin() {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setTimeout(() => {
          window.location.href = "studentpanel/sessionhandler.jsp"; // Redirect after successful login
        }, 2000);
      } else {
